...
# --trace-threads is fatal on Verilator 5.050; GCC 15 -O3 firmware overflows the 96 KiB ROM
MK="make -f $tree/tools/scripts/Makefile debug=1 VERILATOR_TRACE=fst VERILATOR_DEBUG=--trace-fst BUILD_CFLAGS=-O2"
W=$tree/work/trace
case $verb in
  build)
